...
type UserItem struct {
	...
	UserID       uuid.UUID  `json:"user_id" gorm:"type:varchar(36);not null;uniqueIndex:uq_user_items_user_item;uniqueIndex:uq_user_items_user_title;index:idx_user_items_user_redeem_item"`
	...
	PurchaseType string     `json:"purchase_type" gorm:"type:enum('shop','redeem','grant');not null;default:'shop';index"`
