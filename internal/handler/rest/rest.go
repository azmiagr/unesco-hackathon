...
func (r *Rest) MountEndpoint() {
	...
	admin.GET("/dashboard", r.GetDashboardByAdmin)
	...
	admin.PUT("/game-config/general", r.UpsertGameGeneralConfigByAdmin)
	admin.PUT("/game-config/ai", r.UpsertGameAIConfigByAdmin)
	admin.DELETE("/users/:userID", r.HardDeleteUserByAdmin)

	gameLevels := admin.Group("/game-levels")
	gameLevels.GET("", r.ListGameLevelsByAdmin)
	gameLevels.GET("/:gameLevelID", r.GetGameLevelDetailByAdmin)
